...
export const CHOICE_VIEW_PATH = "/mod/choice/view.php";
export const FEEDBACK_VIEW_PATH = "/mod/feedback/view.php";
export const FEEDBACK_COMPLETE_PATH = "/mod/feedback/complete.php";
export const REPOSITORY_UPLOAD_PATH = "/repository/repository_ajax.php";
export const DRAFTFILES_AJAX_PATH = "/repository/draftfiles_ajax.php";
...
export const FUNC_GET_GRADE_OVERVIEW = "gradereport_overview_get_course_grades";
export const FUNC_GET_CALENDAR_UPCOMING = "core_calendar_get_calendar_upcoming_view";
export const FUNC_GET_CALENDAR_MONTHLY = "core_calendar_get_calendar_monthly_view";
export const FUNC_GET_CONVERSATIONS = "core_message_get_conversations";
export const FUNC_GET_CONVERSATION_MESSAGES = "core_message_get_conversation_messages";
export const FUNC_UPDATE_COMPLETION = "core_completion_update_activity_completion_status_manually";
export const FUNC_MARK_ALL_NOTIFICATIONS_READ = "core_message_mark_all_notifications_as_read";
